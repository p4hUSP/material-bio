...
```{r fig.align='center', eval=TRUE}
knitr::include_graphics("imgs/r_data_structures.png")
```
...
2. Usando a indexação, obtenha:
    ...
    - Todas as informações do candidato Ciro Gomes
  
    - O partido  de todos candidatos
  
    - Todas as informações dos dois primeiros colocados

3. Obtenha:

    - A média de votos de todos os candidatos

    - A soma de votos dos dois primeiros candidatos

    - O desvio padrão dos votos
